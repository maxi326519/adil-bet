...
export default function Filter() {
  ...
  const [selected, setSelected] = useState({Alphabetically: 'alpha', league: 'All', teams: 'All', country: 'All'});
  ...
  function handleClick(e) {
    e.preventDefault()
    dispatch(getMatchs())
    setSelected({Alphabetically: 'alpha', league: 'All', teams: 'All', country: 'All'})
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="filtersDiv">
      ...
      <div className="filter">
      <select className='select' value= {selected.league === "All" ? 'league' : null} name= 'league' onChange={(e) => filterState(e)}>
          <option value= 'All' key= 'All'>Filtro por liga</option>
      ...
      <div className="filter">
      <select className='select' value= {selected.teams === "All" ? 'teams' : null} name= 'teams' onChange={(e) => filterState(e)}>
          <option value= 'All' key= 'All'>Filtro por equipo</option>
      ...
      <div className="filter">
      <select className='select' value= {selected.Alphabetically === "alpha" ? 'Alphabetically' : null} name= 'Alphabetically' onChange={(e) => handleName(e)}>
        <option value="alpha" key='alpha' >Alphabetically</option>
        <option value='A to Z' >A to Z</option>
          <option value='Z to A'>Z to A</option>
        </select>
        <button className='btnreload' onClick={handleClick}>RESTART</button>
      </div>
    </form>
  );
}